...
# Mon Dec  5 21:27:39 2022
###############################################################################
current_design caravel_hack_soc
###############################################################################
# Timing Constraints
###############################################################################
...
set_output_delay 8.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq[0]}]
set_output_delay 8.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq[1]}]
set_output_delay 8.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq[2]}]
